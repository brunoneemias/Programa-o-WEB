...
@ManagedBean // Faz a junção das classes
@SessionScoped // Fechar sessão
public class CarrosBean {
    ...
    public void listar(){
        listaCarros = objCarrosDAO.listar(); // Pega a lista da classe carrosDAO e joga no listaCarros que está vínculado na tela
    }
